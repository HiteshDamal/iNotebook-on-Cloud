...
const Notes = (props) => {
     ...
     const handleClick = (e) =>{
      ...
      refClose.current.click(); // Add this line to close the modal
      e.preventDefault();
        ...
        <div className="modal-dialog">
          <div className="modal-content">
            ...
            <div className="modal-footer">
              <button  ref={refClose} type="button" className="btn btn-secondary" data-bs-dismiss="modal" style={{...style1,...style2}}>Close</button>
              <button disabled={note.etitle.length < 3 || note.edescription.length < 3} onClick={handleClick} type="button" className="btn btn-primary" style={{...style1,...style2}} >Update Note</button>
            </div>
          </div>
        </div>
      </div>
